...
function fetchTotals() {
    ...
    const staffNo = urlParams.get('staffNo'); // Get staffNo from the URL

    fetch(`adminworkplancalc.php?action=fetch&staffNo=${staffNo}`)
...
function submitData() {
    ...
    fetch(`adminworkplancalc.php?action=save&staffNo=${staffNo}`, {
        method: 'POST',
